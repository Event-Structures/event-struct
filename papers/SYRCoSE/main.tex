...
has been introduced in the 1980s as an alternative to operational interleving 
semantics of concurrency, and nowadays they are regaining popularity.   
The event structures directly represent the causal dependence and 
conflict between the individual atomic actions of the system, 
this property leads to a more compact encoding of the semantics.

In this report we present a theory of 
event structures mechanized in the \coq proof assistant
